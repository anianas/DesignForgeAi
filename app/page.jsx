    ...
    <>
      ...
      <section style={{ padding: '64px 0', borderTop: '1px solid var(--border)' }}>
        <div className="container">
          ...
          >
            <Feature num="1" title="Describe" body="Paste a B2B idea or pain point in plain language." />
            <Feature num="2" title="Concept" body="Claude returns a sharp brief — name, audience, features, KPIs." />
            <Feature num="3" title="Visualize" body="Pick a design system. We build a live, interactive UI mock." />
            <Feature num="4" title="Export" body="Download a runnable Vite + React project, or keep iterating." />
          </div>
        </div>
      </section>
